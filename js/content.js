  ...
  // ---------------------------------------------------------------- PRÓLOGO
  {
    ...
    secciones: [
      { id: "prologo-1", titulo: "Por qué existe este manual y cómo usarlo", contenido: [
        ...
        { t: "p", x: "La intención es que dentro del manual encuentres respuestas a cómo manejar situaciones cotidianas que hacen al proceso comercial: qué decir en una reunión, qué mirar en la oficina de un cliente, cómo responder cuando alguien te dice que somos caros, cuánto podés negociar sin tener que llamar a nadie, y cómo seguir una cuenta en el tiempo sin perderla de vista. También vas a encontrar, en la última parte, la experiencia real de los propios compañeros: lo que respondieron cuando les preguntamos cómo venden, qué error cometieron alguna vez y qué le dirían a alguien que arranca mañana." },
        { t: "label", x: "Cómo leerlo según tu momento" },
        { t: "bullets", items: [
          "Si sos nuevo en Egran: leelo completo, en orden, antes de tu primera semana de visitas. Te da una base sólida para no arrancar de cero.",
          "Si ya tenés experiencia vendiendo: usalo como consulta. Andá directo a la Parte 4 (los momentos de la venta), la Parte 6 (objeciones) o la Matriz de Situación cuando tengas una duda puntual sobre una negociación.",
          "Si tenés una reunión importante en un rato: repasá la Parte 5 (estructura de la reunión) y la objeción que más se relacione con ese cliente.",
        ]},
  ...
  // ------------------------------------------------------------------ PARTE 2
  {
    ...
    secciones: [
      ...
      { id: "2.4", titulo: "Preparar la propuesta antes de ir", contenido: [
        ...
        { t: "p", x: "Antes de la reunión, repasá qué herramientas pueden sumarle valor a esa cuenta: esta app para preparar el contacto y consultar el manual, la web para presentar la marca y sus productos, y los recursos de puntos de venta y distribuidores para facilitar el acceso a Egran." },
        { t: "p", x: "La sección 'Dónde comprar' de la web le da visibilidad al cliente frente al consumidor final. Presentala como un beneficio sujeto a los criterios de publicación de Egran, sin prometer ventas por el solo hecho de aparecer ahí." },
      ]},
  ...
  // ------------------------------------------------------------------ PARTE 4
  {
    ...
    secciones: [
      ...
      { id: "4.2", titulo: "La primera repetición: qué pasó con esa primera compra", contenido: [
        ...
        { t: "callout", kind: "tip", title: "Si la cuenta te la transfirió el molino", x: "revisá los contactos, condiciones y compromisos de la transferencia antes de visitarla. A los 30 días desde la entrega de esa primera compra, reportá al Responsable Comercial la experiencia del cliente, las oportunidades de ampliar el mix y el potencial segundo pedido (ver 4.9)." },
      ]},
      ...
      { id: "4.7", titulo: "Matriz de Situación: qué se puede negociar según el cliente", contenido: [
        ...
        { t: "label", x: "Autonomía para negociar" },
        { t: "p", x: "La matriz de esta sección es la política comercial aprobada: podés negociar y acordar condiciones dentro de estos descuentos, formas de pago, criterios logísticos y volúmenes, sin pedir autorización adicional para aplicarlos." },
        { t: "callout", kind: "warning", title: "Si una condición excede la matriz", x: "necesita autorización del Directorio antes de comprometerla con el cliente. Presentá la condición solicitada junto con su fundamento comercial." },
        { t: "label", x: "Criterio general de logística" },
        { t: "p", x: "La logística a incluir depende del surtido y los volúmenes operados, no pudiendo superar en ningún caso el 5% del valor de lo solicitado. Para clientes nuevos de Patagonia y Mesopotamia, se concentra la entrega en Buenos Aires." },
        { t: "matriz-dinamica" },
      ...
      { id: "4.9", titulo: "Nuevos clientes: búsqueda propia y oportunidades derivadas", contenido: [
        ...
        { t: "p", x: "Si la consulta es de alguien buscando para consumo personal, se lo orienta hacia los puntos de venta. Si es un comercio cuyo pedido no llega a las condiciones de atención directa, se lo puede orientar a un mayorista o distribuidor de su zona." },
        { t: "label", x: "Antes de la derivación: antecedentes en 24 horas" },
        { t: "p", x: "Si la oportunidad cae en tu zona, te van a consultar si ya trabajaste a ese prospecto. Tenés 24 horas para informar qué hiciste, cuándo, con quién hablaste y qué resultado obtuviste — “lo conozco” o “alguna vez hablé” no alcanza como antecedente." },
        { t: "p", x: "Si nunca lo intentaste, recibís la derivación formal. Si ya lo visitaste o le pasaste precios pero no lograste la primera venta, el molino asume la gestión para intentar concretarla." },
        { t: "label", x: "Después de la derivación: gestionar e informar en diez días corridos" },
        { t: "p", x: "Desde la derivación formal tenés un máximo de diez días corridos para gestionar (llamar, visitar, coordinar una videollamada) y darle al Ejecutivo Comercial Interno una respuesta concreta. No hace falta cerrar la venta en esos diez días, pero sí tiene que haber gestión real y una conclusión que permita decidir cómo seguir." },
        { t: "quote", x: "Contacté al comprador y revisamos la propuesta. Le interesan lentejas y garbanzos; está evaluando el volumen mínimo y el costo de entrega. Necesito confirmar la logística con el molino y acordamos retomar el jueves.", by: "Ejemplo de reporte útil" },
        { t: "callout", kind: "warning", title: "Lo que no sirve como reporte", x: "“está interesado”, “lo estoy viendo” o “después lo llamo” no le dan al resto del equipo información para acompañar la oportunidad. También es útil informar que no corresponde continuar, y explicar por qué." },
        { t: "label", x: "Cuando ya la habías trabajado sin lograr la primera compra" },
        { t: "p", x: "Si vos ya habías intentado venderle sin éxito, el molino la retoma directamente: entiende por qué no compró antes, reformula la propuesta si corresponde, y gestiona el cierre dentro de las condiciones aprobadas. Esa primera venta no genera comisión para vos. Una vez facturado el primer pedido, la cuenta se te transfiere formalmente para desarrollar las compras posteriores, que sí computan para tu comisión." },
        { t: "label", x: "Qué información trae la transferencia" },
        { t: "bullets", items: [
          "Datos de contacto y personas involucradas.",
          "Productos, cantidades, precios y condiciones del primer pedido.",
          "Motivo de la falta de compra anterior, si se identificó, y objeciones ya resueltas.",
          "Compromisos asumidos, fecha de facturación y situación de entrega.",
          "Productos o volúmenes adicionales posibles, y fecha estimada del próximo pedido.",
        ]},
        { t: "p", x: "Revisá esa información antes de contactar al cliente: recibir una cuenta implica retomar lo que el molino ya conversó y prometió, no arrancar de cero." },
        { t: "p", x: "Después de la primera compra, visitá al cliente siguiendo los criterios de 4.2. A los 30 días desde la entrega, reportá al Responsable Comercial cómo resultó, qué devolución recibió, y qué potencial y acciones ves para el segundo pedido." },
        { t: "callout", kind: "tip", title: "Zona y oportunidades grandes", x: "la zona se define por la ubicación operativa principal del prospecto (casa central, punto de distribución o entrega habitual). Tener sucursales en otras localidades no cambia por sí solo la asignación. Las oportunidades de gran escala se presentan primero al Directorio." },
      ]},
    ],
  },
    ...
    secciones: [
      ...
      { id: "7.2", titulo: "Qué registrar y cuándo", contenido: [
        ...
        { t: "bullets", items: [
          ...
          "En oportunidades derivadas: origen de la consulta, antecedentes, fecha de derivación, vencimiento del plazo, acciones realizadas y resultado (ver 4.9).",
        ]},
      ]},
      { id: "7.3", titulo: "La ficha de cliente como herramienta viva", contenido: [
        ...
        { t: "p", x: "Para clientes históricos y nuevos, mantené actualizados y compartidos con el equipo: nombre de fantasía, razón social cuando corresponda, dirección comercial, localidad y teléfono comercial. Esa información alimenta la ficha en sistema y el listado de puntos de venta de 'Dónde comprar'." },
      ]},
    ...
    secciones: [
      { id: "9.1", titulo: "Qué reportamos, cuándo y por qué canal", contenido: [
        ...
        { t: "table", headers: ["Qué reportamos", "Por qué es relevante", "Cuándo", "Canal"], rows: [
          ...
          ["Cuenta en riesgo real", "Cuanto antes se sepa, más chance hay de resolverlo", "Inmediato", "Llamado o WhatsApp directo"],
          ["Oportunidad grande detectada", "Justifica involucrar a Agustín o Fernando directamente", "Inmediato", "Llamado"],
          ["Novedades del cliente o del mercado", "Ayuda a anticiparse en vez de enterarse tarde", "Cuando aparece", "Mail"],
        ]},
